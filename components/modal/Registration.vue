            ...
            <div class="field">
              <p class="control has-icons-left has-icons-right">
                ...
                <span v-if="highlightNameWithError !== null" class="icon is-small is-right">
                  <i :class="[highlightNameWithError ? 'fa fa-exclamation-circle' : 'fa fa-check']" />
                </span>
              </p>
            ...
            <div class="field">
              <p class="control has-icons-left has-icons-right">
                ...
                <span v-if="highlightEmailWithError !== null" class="icon is-small is-right">
                  <i :class="[highlightEmailWithError ? 'fa fa-exclamation-circle' : 'fa fa-check']" />
                </span>
              </p>
            ...
            <div class="field">
              <p class="control has-icons-left has-icons-right">
                ...
                <span v-if="highlightPasswordWithError !== null" class="icon is-small is-right">
                  <i :class="[highlightPasswordWithError ? 'fa fa-exclamation-circle' : 'fa fa-check']" />
                </span>
              </p>
            ...
            <div class="field">
              <p class="control has-icons-left has-icons-right">
                ...
                <span v-if="highlightRepeatPasswordWithError !== null" class="icon is-small is-right">
                  <i :class="[highlightRepeatPasswordWithError ? 'fa fa-exclamation-circle' : 'fa fa-check']" />
                </span>
              </p>
